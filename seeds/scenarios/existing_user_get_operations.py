...
class ExistingUserGetOperationsSeedsScenario(SeedsScenario):
    """
    Сценарий сидинга для существующего пользователя, который загружает список операций и статистику по ним.
    ...
    def plan(self) -> SeedsPlan:
        ...
        В данном случае создаём 300 пользователей, каждому даём кредитный счёт и выполняем 3 операции.
        """
        return SeedsPlan(
            users=SeedUsersPlan(
                count=300,
